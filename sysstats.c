...
int main(int argc, char *argv[]) {
    ...
    struct stat fileStat;          // Declare fileStat here

    char filepath[4096];           // Declare filepath here

    unsigned int fileCount = 0;    // Declare fileCount

    unsigned long long totalSize = 0; // Declare totalSize
